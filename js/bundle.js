...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _services_servicces__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/servicces */ "./js/services/servicces.js");
...
function cards() {
	...
	class MenuCard {
		...
		render() {
			...
			// проверяем наличие классов в ...classes
	...
	(0,_services_servicces__WEBPACK_IMPORTED_MODULE_0__.getResource)('http://localhost:3000/menu')
		.then(data => {
...
/* harmony import */ var _services_servicces__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/servicces */ "./js/services/servicces.js");
...
function forms(formSelector, modalTimerId) {
	...
	function bindPostData(form) {
		form.addEventListener('submit', (e) => {
			...
			(0,_services_servicces__WEBPACK_IMPORTED_MODULE_1__.postData)(' http://localhost:3000/requests', json)
				.then(data => {
					console.log(data);
...
function modal(triggerSelector, modalSelector, modalTimerId) {
	...
	//закрытие модального окна при принажатии Escape
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
	...
	//делигируем события указателей вкладок
...
function timer(id, deadLine) {
	...
	function getTimeRemaining(endtime) {
		//превращает строку во время(в мс) и возвращает разницу
	...
	function setClock(selector, endtime) {
		...
		//запускаем, чтобы убрать мерцание при обновлении
		updateClock();
...
/* harmony export */ });
// настраиваем запрос и возвращаем ответ в json
